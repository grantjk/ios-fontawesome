...
- (void)viewDidLoad
{
    ...
    for (NSUInteger i = 0; i < kStarsNumber; i++) {
        ...
        [star setTitle:[NSString fontAwesomeIconStringForEnum:AU_FAIconStarEmpty] forState:UIControlStateNormal];
        [star setTitle:[NSString fontAwesomeIconStringForEnum:AU_FAIconStar] forState:UIControlStateSelected];
